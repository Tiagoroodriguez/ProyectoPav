            ...
            switch (formMode)
            {
                case FormMode.insert:
                    {
                        if (ExisteUsuario() == false)
                        {
                            if (ValidarCampos())
                            {
                                ...
                                oUsuario.Legajo = Convert.ToInt32(txtLegajo.Text);
                        ...
                        {
                            MessageBox.Show("Nombre de usuario encontrado!. Ingrese un nombre diferente", "Informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            txtNombre.Focus();
                        }
                        break;
                    }
                case FormMode.update:
                    if (ValidarCampos())
                    {
                        ...
                        oUsuarioSelected.Legajo = Convert.ToInt32(txtLegajo.Text);
